...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the Digo service.", fields: {} },
    restart: { description: "Restart the Digo service.", fields: {} },
    check_config: {
      description:
        "Check the Digo configuration files for errors. Errors will be displayed in the Digo log.",
      fields: {},
    },
    update_entity: {
