...
class HaConfigIntegrationPage extends SubscribeMixin(LitElement) {
        ...
        ? html`<ha-card>
          ...
          return html`<ha-list-item
                      ...
                      >
                        ...
                        <span slot="secondary"
                          >${this.hass.localize(
            `ui.panel.config.integrations.${attention ? "attention" : "discovered"
            }`
          )}</span
                        >
                        <ha-button
                          ...
                          @click=${this._continueFlow}
                          .label=${this.hass.localize(
            `ui.panel.config.integrations.${attention ? "reconfigure" : "configure"
            }`
          )}
                        ></ha-button>
                      </ha-list-item>`;
  ...
  private async _handleDisableDebugLogging(ev: Event) {
    ...
    const logFileName = `digo_${integration}_${timeString}.log`;
